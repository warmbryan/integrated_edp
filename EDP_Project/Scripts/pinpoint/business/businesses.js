...
<ItemTemplate>
	...
	<td>
		<asp: <%# (bool)Eval("Verified") ? "Yes" : "No" %>' />
			</td>
	<td>
		<button type="button" class="btn btn-link btn-sm roles" id="<%# Eval(" Id") %>">Roles</button>
	<asp: <%# "~/BDEmployees.aspx?business=" + Eval("Id") %>' runat="server" CssClass="btn-sm btn btn-link">Employees</asp:HyperLink>
				<asp: <%# "~/BDUpdateBusiness.aspx?business=" + Eval("Id") %>' runat="server" CssClass="btn-sm btn btn-link">Update</asp: HyperLink >
