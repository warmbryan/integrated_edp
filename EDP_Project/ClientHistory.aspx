...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-8">
            ...
            <h2>
                <asp:Label ID="lblType" runat="server" Text="View History"></asp:Label>
            </h2>
            ...
            <%--<asp:Panel ID="PanelReviewHistory" runat="server" Visible="False">
                <div class="row" >
                <div class="col-5 text-center border border-dark" style="padding:5px;"><img alt="Image" src="/Public/Image/SearchBG.png" style="height: 150px;" /></div>
                <div class="col-7 text-center border border-dark"><a href="Review.aspx">Review</a><br />Comment/Rating</div>
        ...
        <div class="col-4" style="height: fit-content; position: sticky; top: 90px;">
            ...
            <br />
            <asp:RadioButton ID="RdbtnSearchHistory" runat="server" GroupName="RdgroupHistoryType" Text="Search History" OnCheckedChanged="RdgroupHistoryType_CheckedChanged" AutoPostBack="True" />
