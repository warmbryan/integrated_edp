<%@ Page Title="" Language="C#" MasterPageFile="~/Public.Master" AutoEventWireup="true" CodeBehind="CustomerHome.aspx.cs" Inherits="EDP_Project.CustomerHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        body {
            background-image: url("/assets/Image/SearchBG.png");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" style="margin-top: 25vh;">
        <div style="padding: 5px; width: 60%; text-align: center; color: orange; margin: auto; background-color: white; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <p>PinPoint is a business search directory website.<br />
                Our aim is to gather all the business located in Singapore<br />
                and put them into a search directory for you.</p>
